import { EmbedBuilder, MessageFlags, User, GuildMember, SlashCommandBuilder, ChatInputCommandInteraction } from "discord.js";
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            const memberInfoEmbed = new EmbedBuilder()
                ...
                .setColor('#0099FF')
                .addFields(
                    { name: '📅 Entrou no servidor em', value: `\`${member.joinedAt?.toLocaleString('pt-BR') || 'Indefinido'}\``, inline: true },
                    {
