import { PermissionFlagsBits, SlashCommandBuilder, ChatInputCommandInteraction, MessageFlags, EmbedBuilder, TextChannel } from "discord.js";
...
const banCommand: Command = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addUserOption((option) => option.setName('target').setDescription('Usuário a ser banido').setRequired(true))
