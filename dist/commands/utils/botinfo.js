    ...
    async execute(interaction) {
        try {
            ...
            const botTecnicoInfoEmbed = new EmbedBuilder()
                ...
                .setColor('#5865F2')
                .setThumbnail(client.user?.displayAvatarURL() || "")
                .addFields({ name: '📌 Nome', value: `\`${client.user?.tag}\`` || "Indefinido", inline: true }, { name: '🆔 ID', value: `\`${client.user?.id}\`` || "Indefinido", inline: true }, { name: '⏳ Uptime', value: upTimeStr, inline: true }, { name: '📡 Servidores', value: `\`${client.guilds.cache.size}\``, inline: true }, { name: '👥 Usuários (aprox.)', value: `\`${client.guilds.cache.reduce((acc, g) => acc + g.memberCount, 0)}\``, inline: true }, { name: `${nodeEmoji} Node.JS`, value: `\`${process.version}\``, inline: true }, { name: `${typeScriptEmoji} TypeScript`, value: `\`${tsVersion}\``, inline: true }, { name: `${discordJsEmoji} Discord.js`, value: `\`v14\``, inline: true })
                .setTimestamp();
