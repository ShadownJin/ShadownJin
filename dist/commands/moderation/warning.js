...
const warningCommand = {
    ...
    async execute(interaction) {
        ...
        const executorMembers = interaction.member;
        ...
        const warningEmbed = new EmbedBuilder()
            ...
            .addFields({ name: '👤 Usuário', value: `${targetUser.tag} (${targetUser.id})`, inline: true }, { name: '🛡️ Moderador', value: `${user.tag}`, inline: true }, { name: '🔢 Total de Avisos', value: `${newCount}`, inline: true }, { name: '📝 Motivo', value: reason })
            .setTimestamp()
